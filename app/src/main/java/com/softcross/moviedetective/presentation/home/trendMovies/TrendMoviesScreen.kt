...
@Composable
fun TrendMoviesScreen(
    viewModel: TrendMoviesViewModel = hiltViewModel<TrendMoviesViewModel>()
) {
    val movies = viewModel.trendMoviePagingFlow.collectAsLazyPagingItems()
    LazyVerticalGrid(
