...
class MovieDetailViewModel @Inject constructor(
    ...
    private val _actorMovieState = mutableStateOf<ScreenState<List<Content>>>(ScreenState.Loading)
    val actorMovieState: State<ScreenState<List<Content>>> get() = _actorMovieState
